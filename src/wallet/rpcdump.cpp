...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"gaiacoinaddress\"\n"
            "\nReveals the private key corresponding to 'gaiacoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"gaiacoinaddress\"   (string, required) The gaiacoin address for the private key\n"
            "\nResult:\n"
