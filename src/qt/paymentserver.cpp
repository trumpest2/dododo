...
const QString BITCOIN_IPC_PREFIX("gaiacoin:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/gaiacoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/gaiacoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/gaiacoin-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click gaiacoin: links
...
//
// OSX-specific way of handling gaiacoin: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in gaiacoin: URIs
