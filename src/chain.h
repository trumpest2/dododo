...
enum BlockStatus: uint32_t {
    ...
    BLOCK_HAVE_DATA          =    8, //!< full block available in gaia*.dat
...
public:
    ...
    //! Which # file this block is stored in (gaia?????.dat)
    int nFile;

    //! Byte offset within gaia?????.dat where this block's data is stored
