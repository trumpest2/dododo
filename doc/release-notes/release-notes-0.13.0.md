...
- #7993 `6a034ed` [depends] Bump Fgaiaype, ccache, ZeroMQ, miniupnpc, expat (fanquake)
...
- #7680 `41d2dfa` Remove gaiacoinion from `about` icon (laanwj)
...
- #7662 `386f438` remove unused NOGAIAS_VERSION_{START,END} constants (rat4)
